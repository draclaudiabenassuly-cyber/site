...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: `${baseUrl}/historia`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${baseUrl}/propostas`, lastModified: now, changeFrequency: "monthly", priority: 0.8 },
    { url: `${baseUrl}/compromissos`, lastModified: now, changeFrequency: "daily", priority: 0.9 },
    ...
    { url: `${baseUrl}/galeria`, lastModified: now, changeFrequency: "weekly", priority: 0.8 },
